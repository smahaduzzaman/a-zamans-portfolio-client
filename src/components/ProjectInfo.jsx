    ...
    return (
        <div class="container text-gray-600 body-font overflow-hidden mx-auto px-20">
            <div class="w-full lg:px-10 lg:py-6 mb-10 lg:mb-0">
                <h2 class="text-sm title-font text-gray-500 tracking-widest">PROJECT ID: {id}</h2>
                <h1 class="text-gray-900 text-3xl title-font font-medium mb-4">Project Name: {title}</h1>
                <p class="text-gray-900 text-sm title-font font-medium mb-4">{subtitle}</p>
                ...
                <div className='flex justify-between align-middle my-10 mr-10'>
                    <a href={live} className="text-blue-600/100" target="_blank">Live Link</a>
                    <a href={client} className="text-blue-600/100" target="_blank">GitHub Client</a>
                    <a href={server} className="text-blue-600/100" target="_blank">GitHub Server</a>
                </div>
                ...
                <div class="flex">
                    ...
                    <a href="/contact" class="flex ml-auto btn bg-white text-dark_primary border-0 py-2 px-6 focus:outline-none">Contact Me</a>
